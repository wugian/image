...
class SnowFlake {
    ...
    SnowFlake(Random random, Point position, float angle, float increment, float flakeSize, Paint paint, Bitmap bitmap) {
        mFlowers = bitmap;
        this.random = random;
    ...
    private Bitmap mFlowers = null;

//    public void setFlowers(Bitmap mFlowers) {
...
//    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (mFlowers == null) {
            ...
            canvas.drawBitmap(mFlowers, position.x, position.y, paint);
        }
    }
}
